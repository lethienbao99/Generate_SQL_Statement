...
//string[] tableNames2 = FactoryTableLinks.GenerateTableLinks(input, "GET_PROFILEQUIT", "Hre_Profile.hp", out listDataTableOrigin);
...
//FactorySelectColumns.GenerateSelectColumns(inputColumn, listDataTableOrigin, "GET_PROFILEQUIT");
...
FactoryParameters.GenerateParameters(paramsText, "GET_PROFILEQUIT", false, true);
